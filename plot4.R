...
plot(sub$Time,sub$Global_active_power,type="l",ylab="Global Active Power",xlab="",main="",lwd=0.5)


plot(sub$Time,sub$Sub_metering_1,type="l",ylab="Energy sub metering",xlab="",main="", lwd=0.5)
...
plot(sub$Time,sub$Voltage,type="l",ylab="Voltage",xlab="Datetime",main="",lwd=0.5)

plot(sub$Time,sub$Global_reactive_power,type="l",xlab="Datetime", ylab="global_reactive_power",main="",lwd=0.5)
